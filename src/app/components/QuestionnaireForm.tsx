...
interface QuestionnaireFormProps {
  onSubmit: (strengths: string[], weaknesses: string[], preferences: string[]) => void;
}
...
export default function QuestionnaireForm({ onSubmit }: QuestionnaireFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    onSubmit(selected.strengths, selected.weaknesses, selected.preferences)
  }
  ...
  return (
    ...
    >
      ...
      >
        <Button type="submit" className="w-full">Generate Learning Path</Button>
      </motion.div>
    </motion.form>
  )
}
